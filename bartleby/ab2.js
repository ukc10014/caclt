...
let BLEAK_EXIT; //mostly this is false, until in collector case, we get to specified point when the thing basically shuts down
...
function load_Content() {
    ...
    imgs.num_ue4img = 78*0 + 25; /*Number of images*/
    imgs.curr_img = int(random()*imgs.num_ue4img); /*Initialise starting img (in gallery, 0; on web, random)*/
...
function setup() {
  ...
  imgs.holdtext = 0.5; BLEAK_EXIT = false; 
}

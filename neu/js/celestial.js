...
!(function() {
    ...
    var cfg, mapProjection, zoom, map, circle, daylight, starnames = {},
        dsonames = {};
    ...
    Celestial.display = function(config) {
        ...
        if ($("loc") === null) geo(cfg);
        else if (cfg.location === true && cfg.follow === "zenith") rotate({
    ...
    */
    ...
    function form(cfg) {
        ...
        if (div.size() < 1) {
            ...
            div = d3.select("#" + container).select(function() {
    ...
    */
    ...
    var Moon = {
        ...
        corr: function(dat, sol) {
            ...
            dat.ra += lon;
            var lat = -0.003019 * Math.sin(L - 2 * E) +

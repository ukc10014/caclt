!function(e, t) {
    ...
    function h(e) {
        ...
        return t && i && M(n) > 0 && a(n, (function(e, n) {
    ...
    var _ = function() {
        function e(i, n) {
            ...
            this.isDoubleTap = !1;
            var s = function() {};
            this.rotate = B(this.element, n.rotate || s),
            this.touchStart = B(this.element, n.touchStart || s),
            this.multipointStart = B(this.element, n.multipointStart || s),
            this.multipointEnd = B(this.element, n.multipointEnd || s),
            this.pinch = B(this.element, n.pinch || s),
            this.swipe = B(this.element, n.swipe || s),
            this.tap = B(this.element, n.tap || s),
            this.doubleTap = B(this.element, n.doubleTap || s),
            this.longTap = B(this.element, n.longTap || s),
            this.singleTap = B(this.element, n.singleTap || s),
            this.pressMove = B(this.element, n.pressMove || s),
            this.twoFingerPressMove = B(this.element, n.twoFingerPressMove || s),
            this.touchMove = B(this.element, n.touchMove || s),
            this.touchEnd = B(this.element, n.touchEnd || s),
            this.touchCancel = B(this.element, n.touchCancel || s),
            ...
            value: function(e) {
                if (e.touches) {
                    ...
                    i > 1) {
                        ...
                        null !== t.x && (this.pinchStartLen > 0 && (e.zoom = D(r) / this.pinchStartLen,
    ...
    function W(e) {
        if (e.events.hasOwnProperty("touch"))
            return !1;
        var t, i, n, s = x(), l = s.width, o = s.height, r = !1, a = null, h = null, c = null, f = !1, m = 1, y = 1, b = !1, S = !1, w = null, T = null, k = null, C = null, E = 0, A = 0, L = !1, O = !1, X = {}, z = {}, Y = 0, M = 0, I = document.getElementById("glightbox-slider"), q = document.querySelector(".goverlay"), D = new _(I,{
            touchStart: function(t) {
                ...
                r = !0,
                z = t.targetTouches[0],
                X.pageX = t.targetTouches[0].pageX,
                X.pageY = t.targetTouches[0].pageY,
            ...
            touchMove: function(s) {
                if (r && (z = s.targetTouches[0],
                !b && !S)) {
                    if (n && n.offsetHeight > o) {
                        var a = X.pageX - z.pageX;
                        if (Math.abs(a) <= 13)
                            return !1
                    }
                    f = !0;
                    var d, u = s.targetTouches[0].clientX, g = s.targetTouches[0].clientY, v = Y - u, m = M - g;
    ...
    function R(e, t, i) {
        ...
        T(this.settings.plyr.js, "Plyr", (function() {
            ...
            var x = Y(n.settings.plyr, "config") ? n.settings.plyr.config : {}
              , S = new Plyr("#" + l,x);
    ...
    function Z(e, t, i) {
        var n, s = this, l = e.querySelector(".gslide-media"), o = !(!Y(t, "href") || !t.href) && t.href.split("#").pop().trim(), r = !(!Y(t, "content") || !t.content) && t.content;
        if (r && (E(r) && (n = b('<div class="ginlined-content">'.concat(r, "</div>"))),
        A(r))) {
    ...
    var U = function() {
        ...
        return n(e, [{
            ...
            value: function(e, t) {
                ...
                if (X(e) && !A(e)) {
                    Y(e, "type") || (Y(e, "content") && e.content ? e.type = "inline" : Y(e, "href") && (e.type = this.sourceType(e.href)));
                    var s = r(n, e);
                ...
                n.href = l,
                a(n, (function(s, l) {
                    Y(t, l) && "width" !== l && (n[l] = t[l]);
                    var o = e.dataset[l];
                    z(o) || (n[l] = i.sanitizeValue(o))
                }
                )),
            ...
            value: function(e, t) {
                ...
                return e.width = Y(e, "width") && "" !== e.width ? this.checkSize(e.width) : i,
                e.height = Y(e, "height") && "" !== e.height ? this.checkSize(e.height) : n,
                e
            }
        }, {
            key: "checkSize",
        ...
        return n(e, [{
            ...
            value: function() {
                ...
                if (A(e)) {
                    ...
                    z(i) && (i = this.getElementIndex(e)) < 0 && (i = 0)
                }
                I(i) || (i = 0),
                this.build(),
                ...
                Q && this.settings.touchNavigation && W(this),
                this.settings.keyboardNavigation && q(this)
            }
        }, {
            key: "openAt",
            value: function() {
            ...
            value: function(e) {
                if (e < 0 || e > this.elements.length - 1)
                    return !1;
                if (z(this.elements[e]))
                    return !1;
                var t = this.slidesContainer.querySelectorAll(".gslide")[e];
                if (g(t, "loaded"))
                    return !1;
            ...
            value: function(e, t) {
                ...
                t)
                    f(e, this.settings.openEffect, (function() {
            ...
            value: function() {
                ...
                !z(this.settings.elements) && L(this.settings.elements) && a(this.settings.elements, (function(i, n) {
                    var s = new J(i,e)
                      , l = s.getConfig();
                    l.node = !1,
                    l.index = n,
            ...
            value: function() {
                ...
                if (this.built)
                    return !1;
                var t = Y(this.settings.svg, "next") ? this.settings.svg.next : ""
                  , i = Y(this.settings.svg, "prev") ? this.settings.svg.prev : ""
                  , n = Y(this.settings.svg, "close") ? this.settings.svg.close : ""
                  , s = this.settings.lightboxHtml;
                s = b(s = (s = (s = s.replace(/{nextSVG}/g, t)).replace(/{prevSVG}/g, i)).replace(/{closeSVG}/g, n)),
            ...
            value: function() {
                ...
                if ((e = e || this.activeSlide) && !g(e, "zoomed")) {
                    ...
                    i || n) {
                        ...
                        if (i) {
                            var v = Y(this.settings.plyr.config, "ratio") ? this.settings.plyr.config.ratio : "16:9"
                              , f = v.split(":")
                              , p = 900
            ...
            key: "loop",
            value: function() {
                var e = Y(this.settings, "loopAtEnd") ? this.settings.loopAtEnd : null;
                return e = Y(this.settings, "loop") ? this.settings.loop : e,
                e
            }
        }, {
            key: "close",
            value: function() {
                ...
                f(this.activeSlide, this.settings.closeEffect, (function() {
